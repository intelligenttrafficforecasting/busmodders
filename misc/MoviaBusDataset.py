...
class MoviaBusDataset(Dataset):
    ...
    def __init__(self, root_dir, prev_timesteps = 0, verbose = False, interpolation = False, normalize = False, prediction_steps=1):
        """
        Args:
            ...
            prediction_steps (Int): The number of time steps into the future we want to predict. This controls the target data
        """
        ...
        for file in files:
            ...
            self.__data_per_dataframe = len(dataframe) - self.__prev_timesteps - self.__prediction_steps 
    ...
    def __getitem__(self, idx):
        ...
        idx_target = idx + self.__prediction_steps - 1
